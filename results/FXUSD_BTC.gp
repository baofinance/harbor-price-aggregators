# FXUSD_BTC Oracle Price History
set datafile separator ","
set terminal svg enhanced size 600 600 background rgb "gray90"
# set output "FXUSD_BTC.svg"

set title "FXUSD/BTC Oracle History"
...
plot "FXUSD_BTC.csv" skip 1 using 2:($3/1e12) with lines lc rgb "blue", \
