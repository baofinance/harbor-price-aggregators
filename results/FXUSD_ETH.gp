# FXUSD_ETH Oracle Price History
set datafile separator ","
set terminal svg enhanced size 600 600 background rgb "gray90"
# set output "FXUSD_ETH.svg"

set title "FXUSD/ETH Oracle History"
...
plot "FXUSD_ETH.csv" skip 1 using 2:($3/1e12) with lines lc rgb "blue", \
