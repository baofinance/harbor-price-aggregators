# FXUSD_MCAP Oracle Price History
set datafile separator ","
set terminal svg enhanced size 600 600 background rgb "gray90"
# set output "FXUSD_MCAP.svg"

set title "FXUSD/MCAP Oracle History"
...
# Scale: price divided by 1e18 (to get ~0.32), rate divided by 1e18
plot "FXUSD_MCAP.csv" skip 1 using 2:($3/1e18) with lines lc rgb "blue", \
     "" skip 1 using 2:($4/1e18) with lines lc rgb "cyan", \
