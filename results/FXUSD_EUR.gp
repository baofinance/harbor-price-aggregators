# FXUSD_EUR Oracle Price History
set datafile separator ","
set terminal svg enhanced size 600 600 background rgb "gray90"
# set output "FXUSD_EUR.svg"

set title "FXUSD/EUR Oracle History"
...
# Scale: price divided by 1e18 (to get ~0.85), rate divided by 1e18
plot "FXUSD_EUR.csv" skip 1 using 2:($3/1e18) with lines lc rgb "blue", \
