...
/// @notice Arbitrum stETH/MAG7 oracle.
/// @dev Hard-coded wiring for Arbitrum; deploy scripts select this bytecode by chain.
/// @custom:oz-upgrades-unsafe-allow constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_stETH_MAG7_arbitrum is Aggregator_stETH_MAG7 {
    constructor()
        Aggregator_stETH_MAG7(
            WSTETH_STETH.FEED, // Rate feed
            STETH_USD.FEED, // Base USD feed (stETH/USD)
            STETH_USD.HEARTBEAT, // Base USD feed heartbeat
            [
                Aggregator_stETH_MAG7.FeedConfig({feed: AAPL_USD.FEED, heartbeat: AAPL_USD.HEARTBEAT}),
                Aggregator_stETH_MAG7.FeedConfig({feed: MSFT_USD.FEED, heartbeat: MSFT_USD.HEARTBEAT}),
                Aggregator_stETH_MAG7.FeedConfig({feed: TSLA_USD.FEED, heartbeat: TSLA_USD.HEARTBEAT}),
                Aggregator_stETH_MAG7.FeedConfig({feed: GOOGL_USD.FEED, heartbeat: GOOGL_USD.HEARTBEAT}),
                Aggregator_stETH_MAG7.FeedConfig({feed: META_USD.FEED, heartbeat: META_USD.HEARTBEAT}),
                Aggregator_stETH_MAG7.FeedConfig({feed: AMZN_USD.FEED, heartbeat: AMZN_USD.HEARTBEAT}),
                Aggregator_stETH_MAG7.FeedConfig({feed: NVDA_USD.FEED, heartbeat: NVDA_USD.HEARTBEAT})
            ]
        )
    {}
}
