...
/// @notice USDE/BTC oracle (rate: sUSDe/USDe feed, price: (USDE/USD)/(BTC/USD)).
/// @dev Price excludes wrapped rate; rate is returned separately.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_USDE_BTC is HarborAggregator_v3 {
