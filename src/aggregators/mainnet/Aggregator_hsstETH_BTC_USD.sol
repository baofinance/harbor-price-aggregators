...
/// @notice hsstETH-BTC/USD oracle (rate: minter leveragedTokenPrice, price: rate × single-feed price).
/// @dev Same single-feed pattern; rate from minter. Feed must be BTC/USD so price in USD = rate × BTC/USD.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_hsstETH_BTC_USD is HarborAggregator_v3 {
