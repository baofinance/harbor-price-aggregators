...
/// @notice hsstETH-GOLD/USD oracle (rate: minter leveragedTokenPrice, price: rate × single-feed price).
/// @dev Same single-feed pattern; rate from minter. Feed must be XAU/USD so price in USD = rate × XAU/USD.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_hsstETH_GOLD_USD is HarborAggregator_v3 {
