...
/// @notice hsfxUSD-SILVER/USD oracle (rate: minter leveragedTokenPrice, price: rate × single-feed price).
/// @dev Same single-feed pattern as Aggregator_fxUSD_SILVER; rate from minter, feed price multiplied by rate.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_hsfxUSD_SILVER_USD is HarborAggregator_v3 {
