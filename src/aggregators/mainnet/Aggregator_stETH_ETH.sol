...
/// @notice stETH/ETH oracle (rate: wstETH->stETH, price: stETH/ETH).
/// @dev Returns (stethEthPrice, stethEthPrice, wstethRate, wstethRate).
///      HarborYield combines price * rate / 1e18 to value wstETH in ETH terms (~1.15e18).
///      This is the formula contract; wiring (feeds/addresses) is provided via constructor.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_stETH_ETH is HarborAggregator_v3 {
