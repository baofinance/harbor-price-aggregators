...
/// @notice hsfxUSD-ETH/USD oracle (rate: minter leveragedTokenPrice, price: rate × single-feed price).
/// @dev Same single-feed pattern as Aggregator_hsfxUSD_BTC_USD; rate from minter, feed price multiplied by rate.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_hsfxUSD_ETH_USD is HarborAggregator_v3 {
