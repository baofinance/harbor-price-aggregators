...
/// @notice hsfxUSD-GOLD/USD oracle (rate: minter leveragedTokenPrice, price: rate × single-feed price).
/// @dev Same single-feed pattern as Aggregator_fxUSD_GOLD; rate from minter, feed price multiplied by rate.
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
contract Aggregator_hsfxUSD_GOLD_USD is HarborAggregator_v3 {
