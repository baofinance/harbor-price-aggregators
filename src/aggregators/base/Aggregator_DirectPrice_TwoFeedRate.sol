...
/// @notice Oracle with direct price from one CL feed and rate from two CL feeds (numerator/denominator).
/// @dev Use when price has a direct feed but harvest/accounting still needs the rate (e.g. wstETH/USD: price = WSTETH_USD, rate = WSTETH_USD/STETH_USD).
/// @custom:oz-upgrades-unsafe-allow state-variable-immutable constructor
// solhint-disable-next-line contract-name-capwords
abstract contract Aggregator_DirectPrice_TwoFeedRate is HarborAggregator_v3 {
