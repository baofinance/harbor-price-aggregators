...
library SingleFeedPriceLib {
    function getPrice(AggregatorV3Interface feed, uint8 feedDecimals, uint256 heartbeat, uint256 divisor, bool invert)
        internal
        view
        returns (uint256)
    {
    ...
    function computeFromValidatedFeedPrice(uint256 feedPrice, uint256 divisor, bool invert)
        internal
        pure
        returns (uint256)
    {
