...
/// @notice Ethereum mainnet SILVER/ETH oracle.
/// @dev Hard-coded wiring for mainnet; deploy scripts select this bytecode by chain.
/// @custom:oz-upgrades-unsafe-allow constructor
// solhint-disable-next-line contract-name-capwords
contract EthPriceAggregator_SILVER_mainnet is Aggregator_Peg_ETH {
    constructor() Aggregator_Peg_ETH(XAG_USD.FEED, XAG_USD.HEARTBEAT, ETH_USD.FEED, ETH_USD.HEARTBEAT) {}
