...
contract EthPriceAggregator_BTC_mainnet is Aggregator_Peg_ETH {
    constructor() Aggregator_Peg_ETH(BTC_USD.FEED, BTC_USD.HEARTBEAT, ETH_USD.FEED, ETH_USD.HEARTBEAT) {}
