...
test_oracle() {
  ...
  local base_name=$("$CAST" call "$address" "base()(string)" --rpc-url "$ARBITRUM_RPC_URL" 2>/dev/null || echo "")
...
declare -a ORACLES=(
  # USDE Stock Oracles
  "src/arbitrum/Oracle_USDE_AAPL_arbitrum.sol:Oracle_USDE_AAPL_arbitrum|USDE_AAPL|USDE/AAPL"
  "src/arbitrum/Oracle_USDE_AMZN_arbitrum.sol:Oracle_USDE_AMZN_arbitrum|USDE_AMZN|USDE/AMZN"
  "src/arbitrum/Oracle_USDE_GOOGL_arbitrum.sol:Oracle_USDE_GOOGL_arbitrum|USDE_GOOGL|USDE/GOOGL"
  "src/arbitrum/Oracle_USDE_META_arbitrum.sol:Oracle_USDE_META_arbitrum|USDE_META|USDE/META"
  "src/arbitrum/Oracle_USDE_MSFT_arbitrum.sol:Oracle_USDE_MSFT_arbitrum|USDE_MSFT|USDE/MSFT"
  "src/arbitrum/Oracle_USDE_NVDA_arbitrum.sol:Oracle_USDE_NVDA_arbitrum|USDE_NVDA|USDE/NVDA"
  "src/arbitrum/Oracle_USDE_SPY_arbitrum.sol:Oracle_USDE_SPY_arbitrum|USDE_SPY|USDE/SPY"
  "src/arbitrum/Oracle_USDE_TSLA_arbitrum.sol:Oracle_USDE_TSLA_arbitrum|USDE_TSLA|USDE/TSLA"
  "src/arbitrum/Oracle_USDE_MAG7_arbitrum.sol:Oracle_USDE_MAG7_arbitrum|USDE_MAG7|USDE/MAG7"
  "src/arbitrum/Oracle_USDE_MAG7i26_arbitrum.sol:Oracle_USDE_MAG7i26_arbitrum|USDE_MAG7i26|USDE/MAG7.i26"
  
  # stETH Stock Oracles
  "src/arbitrum/Oracle_stETH_AAPL_arbitrum.sol:Oracle_stETH_AAPL_arbitrum|STETH_AAPL|stETH/AAPL"
  "src/arbitrum/Oracle_stETH_AMZN_arbitrum.sol:Oracle_stETH_AMZN_arbitrum|STETH_AMZN|stETH/AMZN"
  "src/arbitrum/Oracle_stETH_GOOGL_arbitrum.sol:Oracle_stETH_GOOGL_arbitrum|STETH_GOOGL|stETH/GOOGL"
  "src/arbitrum/Oracle_stETH_META_arbitrum.sol:Oracle_stETH_META_arbitrum|STETH_META|stETH/META"
  "src/arbitrum/Oracle_stETH_MSFT_arbitrum.sol:Oracle_stETH_MSFT_arbitrum|STETH_MSFT|stETH/MSFT"
  "src/arbitrum/Oracle_stETH_NVDA_arbitrum.sol:Oracle_stETH_NVDA_arbitrum|STETH_NVDA|stETH/NVDA"
  "src/arbitrum/Oracle_stETH_SPY_arbitrum.sol:Oracle_stETH_SPY_arbitrum|STETH_SPY|stETH/SPY"
  "src/arbitrum/Oracle_stETH_TSLA_arbitrum.sol:Oracle_stETH_TSLA_arbitrum|STETH_TSLA|stETH/TSLA"
  "src/arbitrum/Oracle_stETH_MAG7_arbitrum.sol:Oracle_stETH_MAG7_arbitrum|STETH_MAG7|stETH/MAG7"
  "src/arbitrum/Oracle_stETH_MAG7i26_arbitrum.sol:Oracle_stETH_MAG7i26_arbitrum|STETH_MAG7i26|stETH/MAG7.i26"
)
