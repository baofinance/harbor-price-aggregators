...
declare -a ORACLES=(
  # USDM/USDMY oracles
  "src/megaeth/Aggregator_USDM_ETH_megaeth.sol:Aggregator_USDM_ETH_megaeth|USDM_ETH|USDM/ETH"
  "src/megaeth/Aggregator_USDM_BTC_megaeth.sol:Aggregator_USDM_BTC_megaeth|USDM_BTC|USDM/BTC"
  "src/megaeth/Aggregator_USDM_HYPE_megaeth.sol:Aggregator_USDM_HYPE_megaeth|USDM_HYPE|USDM/HYPE"
  "src/megaeth/Aggregator_USDM_SOL_megaeth.sol:Aggregator_USDM_SOL_megaeth|USDM_SOL|USDM/SOL"
  # USDE/sUSDe oracles
  "src/megaeth/Aggregator_USDE_ETH_megaeth.sol:Aggregator_USDE_ETH_megaeth|USDE_ETH|USDE/ETH"
  "src/megaeth/Aggregator_USDE_BTC_megaeth.sol:Aggregator_USDE_BTC_megaeth|USDE_BTC|USDE/BTC"
  # Core USD pairs
  ...
  "src/megaeth/Aggregator_stETH_USD_megaeth.sol:Aggregator_stETH_USD_megaeth|STETH_USD|stETH/USD"
)
...
if [[ $FAILED -eq 0 ]] && [[ $TEST_FAILED -eq 0 ]]; then
  ...
  echo ""
  echo "📋 Next steps:"
  echo "   Verify on Blockscout: ./script/megaeth/verify/verify-megaeth-v4-oracles.sh"
  echo "   Verify on mega.etherscan.io: ./script/megaeth/verify/verify-megaeth-direct-api.sh"
else
