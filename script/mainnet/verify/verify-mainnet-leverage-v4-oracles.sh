...
# Verify all Mainnet Leveraged Token v4 oracles on Etherscan
# This script reads from deployments/mainnet/leverage-v4-oracles.json and verifies all contracts
...
if [[ ! -f "$DEPLOYMENT_FILE" ]]; then
  ...
  echo "   Run deploy-mainnet-leverage-v4-oracles.sh first"
  exit 1
fi

echo "=== Verifying Mainnet Leveraged Token v4 Oracles ==="
echo ""
