...
# Includes: stETH/USD, wBTC/USD, tBTC/USD, PAXG/USD, and all sUSDe aggregators
...
declare -a ORACLES=(
  # New v4 Oracles
  "src/mainnet/Aggregator_stETH_USD_mainnet.sol:Aggregator_stETH_USD_mainnet|STETH_USD|stETH/USD"
  ...
  # USDE Oracles (rate sourced from sUSDe)
  "src/mainnet/Aggregator_USDE_BTC_mainnet.sol:Aggregator_USDE_BTC_mainnet|USDE_BTC|USDE/BTC"
  "src/mainnet/Aggregator_USDE_ETH_mainnet.sol:Aggregator_USDE_ETH_mainnet|USDE_ETH|USDE/ETH"
  "src/mainnet/Aggregator_USDE_EUR_mainnet.sol:Aggregator_USDE_EUR_mainnet|USDE_EUR|USDE/EUR"
  "src/mainnet/Aggregator_USDE_MCAP_mainnet.sol:Aggregator_USDE_MCAP_mainnet|USDE_MCAP|USDE/MCAP"
  "src/mainnet/Aggregator_USDE_GOLD_mainnet.sol:Aggregator_USDE_GOLD_mainnet|USDE_GOLD|USDE/GOLD"
  "src/mainnet/Aggregator_USDE_SILVER_mainnet.sol:Aggregator_USDE_SILVER_mainnet|USDE_SILVER|USDE/SILVER"
)
