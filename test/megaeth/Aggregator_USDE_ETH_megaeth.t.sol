...
import {Aggregator_USDE_ETH_megaeth} from "@harbor-price/megaeth/Aggregator_USDE_ETH_megaeth.sol";

/// @notice USDE/ETH on megaeth: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_USDE_ETH_megaeth_Test is WiredDoubleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_USDE_ETH_megaeth());
    }
}
