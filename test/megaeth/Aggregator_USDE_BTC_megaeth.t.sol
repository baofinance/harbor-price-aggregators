...
import {Aggregator_USDE_BTC_megaeth} from "@harbor-price/megaeth/Aggregator_USDE_BTC_megaeth.sol";

/// @notice USDE/BTC on megaeth: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_USDE_BTC_megaeth_Test is WiredDoubleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_USDE_BTC_megaeth());
    }
}
