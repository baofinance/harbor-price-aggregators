...
abstract contract ArbitrumMultiFeedIndexAggregatorTestBase is Test {
    ...
    uint256 constant INDEX_PRICE = 2500e18; // Sum of 7 stocks at baseline (18 decimals)
    ...
    /// @notice Returns the contract name (e.g., "Aggregator_stETH_MAG7i26")
    ...
    /// @notice Deploy with zero index price (for revert test)
    function _createWithZeroIndexPrice() internal virtual;
    ...
    function test_constructor_revertsOnZeroIndexPrice() public {
        vm.expectRevert();
        _createWithZeroIndexPrice();
    }
