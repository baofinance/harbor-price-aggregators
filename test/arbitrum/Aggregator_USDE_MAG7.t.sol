...
import {ArbitrumMultiFeedSumAggregatorTestBase} from "@harbor-test/arbitrum/ArbitrumMultiFeedSumAggregatorTestBase.sol";
...
contract Aggregator_USDE_MAG7_Test is ArbitrumMultiFeedSumAggregatorTestBase {
    ...
    function _createAggregator(
        ...
        return
            IHarborPriceAggregatorV3(
                address(new Aggregator_USDE_MAG7(rateFeed, baseUsdFeed, baseUsdFeedHeartbeat, feedConfigs))
            );
    }
    ...
    function _createWithZeroRateFeed() internal override {
        ...
        new Aggregator_USDE_MAG7(address(0), address(mockBaseUsdFeed), DEFAULT_HEARTBEAT, feedConfigs);
    }
    ...
    function _createWithZeroBaseUsdFeed() internal override {
        ...
        new Aggregator_USDE_MAG7(address(mockRateFeed), address(0), DEFAULT_HEARTBEAT, feedConfigs);
    }
    ...
    function _createWithZeroFeed(uint256 feedIndex) internal override {
        ...
        new Aggregator_USDE_MAG7(address(mockRateFeed), address(mockBaseUsdFeed), DEFAULT_HEARTBEAT, feedConfigs);
    }
}
