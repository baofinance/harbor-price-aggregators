...
import {Aggregator_stETH_META} from "@harbor-price/aggregators/arbitrum/Aggregator_stETH_META.sol";

contract Aggregator_stETH_META_Test is ArbitrumDoubleFeedAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_stETH_META).name;
    }
