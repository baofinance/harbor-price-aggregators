...
import {Aggregator_stETH_GOOGL} from "@harbor-price/aggregators/arbitrum/Aggregator_stETH_GOOGL.sol";

contract Aggregator_stETH_GOOGL_Test is ArbitrumDoubleFeedAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_stETH_GOOGL).name;
    }
