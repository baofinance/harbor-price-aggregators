...
import {Aggregator_USDE_META} from "@harbor-price/aggregators/arbitrum/Aggregator_USDE_META.sol";

contract Aggregator_USDE_META_Test is ArbitrumDoubleFeedAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_USDE_META).name;
    }
