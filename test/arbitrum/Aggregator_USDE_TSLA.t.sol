...
import {Aggregator_USDE_TSLA} from "@harbor-price/aggregators/arbitrum/Aggregator_USDE_TSLA.sol";

contract Aggregator_USDE_TSLA_Test is ArbitrumDoubleFeedAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_USDE_TSLA).name;
    }
