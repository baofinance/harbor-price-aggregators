...
import {Aggregator_USDE_AAPL} from "@harbor-price/aggregators/arbitrum/Aggregator_USDE_AAPL.sol";

contract Aggregator_USDE_AAPL_Test is ArbitrumDoubleFeedAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_USDE_AAPL).name;
    }
