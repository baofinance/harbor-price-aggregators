...
/// @notice stETH/MAG7i26 on arbitrum: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_stETH_MAG7i26_arbitrum_Test is WiredFeedOverIndexHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_stETH_MAG7i26_arbitrum());
    }
}
