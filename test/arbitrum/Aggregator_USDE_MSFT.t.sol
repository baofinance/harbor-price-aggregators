...
import {Aggregator_USDE_MSFT} from "@harbor-price/aggregators/arbitrum/Aggregator_USDE_MSFT.sol";

contract Aggregator_USDE_MSFT_Test is ArbitrumDoubleFeedAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_USDE_MSFT).name;
    }
