...
import {Aggregator_GOLD_ETH_mainnet} from "@harbor-price/mainnet/Aggregator_GOLD_ETH_mainnet.sol";

/// @notice GOLD/ETH on mainnet: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_GOLD_ETH_mainnet_Test is WiredDoubleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_GOLD_ETH_mainnet());
    }
}
