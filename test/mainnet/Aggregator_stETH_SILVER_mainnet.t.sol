...
import {Aggregator_stETH_SILVER_mainnet} from "@harbor-price/mainnet/Aggregator_stETH_SILVER_mainnet.sol";

/// @notice stETH/SILVER on mainnet: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_stETH_SILVER_mainnet_Test is WiredDoubleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_stETH_SILVER_mainnet());
    }
}
