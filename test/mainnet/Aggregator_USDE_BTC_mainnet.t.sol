...
import {Aggregator_USDE_BTC_mainnet} from "@harbor-price/mainnet/Aggregator_USDE_BTC_mainnet.sol";

/// @notice USDE/BTC on mainnet: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_USDE_BTC_mainnet_Test is WiredDoubleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_USDE_BTC_mainnet());
    }
}
