...
/// @notice fxUSD/MCAP on mainnet: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_fxUSD_MCAP_mainnet_Test is WiredSingleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_fxUSD_MCAP_mainnet());
    }
}
