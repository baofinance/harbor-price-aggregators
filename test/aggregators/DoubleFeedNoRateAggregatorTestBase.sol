...
abstract contract DoubleFeedNoRateAggregatorTestBase is WrappedPriceOracleConformance {
    ...
    /// @notice Returns the contract name (e.g., "Aggregator_wBTC_USD")
    ...
    function setUp() public virtual {
        ...
        mockFirstFeed.setAnswer(1e8, block.timestamp); // Default: 1.0 (for wBTC/BTC or tBTC/USD)
        mockSecondFeed.setAnswer(50000e8, block.timestamp); // Default: BTC/USD = 50000
