...
/// @title Base test contract for double-feed v3 aggregators with sUSDe rate (sUSDe pattern)
/// @notice Provides all tests; concrete contracts only implement factory + identity
abstract contract DoubleFeedSUSDEAggregatorTestBase is Test {
    MockSUSDe mockSUSDe;
    ...
    /// @notice Returns the contract name (e.g., "Aggregator_sUSDe_BTC")
    ...
    /// @notice Deploy with zero susde (for revert test)
