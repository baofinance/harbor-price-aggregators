...
import {DoubleFeedUSDMAggregatorTestBase} from "./DoubleFeedUSDMAggregatorTestBase.sol";
import {IHarborPriceAggregatorV3} from "@harbor-price/interfaces/IHarborPriceAggregatorV3.sol";
import {Aggregator_USDM_HYPE} from "@harbor-price/aggregators/megaeth/Aggregator_USDM_HYPE.sol";

contract Aggregator_USDM_HYPE_Test is DoubleFeedUSDMAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_USDM_HYPE).name;
    }
