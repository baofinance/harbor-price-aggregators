...
import {Aggregator_USDE_EUR} from "@harbor-price/aggregators/mainnet/Aggregator_USDE_EUR.sol";

contract Aggregator_USDE_EUR_Test is DoubleFeedUSDEAggregatorTestBase {
    function _contractName() internal pure override returns (string memory) {
        return type(Aggregator_USDE_EUR).name;
    }
