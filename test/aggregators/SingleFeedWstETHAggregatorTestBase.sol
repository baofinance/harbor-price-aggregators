...
/// @title Base test contract for single-feed v3 aggregators with wstETH rate (wstETH/USD pattern)
/// @notice Provides all tests; concrete contracts only implement factory + identity
abstract contract SingleFeedWstETHAggregatorTestBase is Test {
    ...
    /// @notice Returns the contract name (e.g., "Aggregator_wstETH_USD")
