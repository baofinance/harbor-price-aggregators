...
import {SingleFeedNoRateAggregatorTestBase} from "@harbor-test/aggregators/SingleFeedNoRateAggregatorTestBase.sol";
...
contract Aggregator_PAXG_USD_Test is SingleFeedNoRateAggregatorTestBase {
    ...
    function _createAggregator(
        ...
        return IHarborPriceAggregatorV3(address(new Aggregator_PAXG_USD(priceFeed, heartbeat, divisor, invert)));
    }
