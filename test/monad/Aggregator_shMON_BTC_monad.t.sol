...
import {Aggregator_shMON_BTC_monad} from "@harbor-price/monad/Aggregator_shMON_BTC_monad.sol";

/// @notice shMON/BTC on monad: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_shMON_BTC_monad_Test is WiredDoubleFeedHarness {
    ...
    function _createAggregator() internal override returns (address) {
        return address(new Aggregator_shMON_BTC_monad());
    }
}
