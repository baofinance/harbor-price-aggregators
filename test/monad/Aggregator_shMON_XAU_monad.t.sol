...
import {Aggregator_shMON_XAU_monad} from "@harbor-price/monad/Aggregator_shMON_XAU_monad.sol";

/// @notice shMON/XAU on monad: what it announces, what it reads, what it composes,
///         and how it fails when a source misbehaves
contract Aggregator_shMON_XAU_monad_Test is WiredDoubleFeedHarness {
